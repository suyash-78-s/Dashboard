...
const DayWiseActivity = () => {
  ...
  return (
    <div>
      ...
      <center><h3>Day Wise Activity</h3></center>

      {data.dayWiseActivity.map((day, index) => (
        <div key={index}>
          <center><h4>Date:{day.date}</h4></center>
          <table>
          <thead>
          ...
          <tbody>
                {day.items.children.map((item, itemIndex) => (
                    <tr key={itemIndex} style={{ color: item.fillColor }}>
